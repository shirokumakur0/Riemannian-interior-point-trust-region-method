...
from utils import evaluation, tangentorthobasis, operator2matrix, tangent2vec, TangentSpaceConjResMethod, selfadj_operator2matrix, NonlinearProblem
...
def barGxaj(x, dx, egradineqconstraints):
    ...
    for idx in range(len(egradineqconstraints)):
        egrad = egradineqconstraints[idx]
        """↓まあここはpackingcirclesでぶつかるやろうなあ，vectorizefunで解消でしょうね
        ということはmanifoldも引数に取ることになるでしょうね..."""
