...
class RIPTRM(Solver):
    ...
    def assert_inner_option(self, inner_option):
    ...
    def inner_iteration(self, problem, outer_iteration, outer_start_time, x_initial, y_initial, mu, initial_TR_radius, inner_option):
        self.assert_inner_option(inner_option)
        # Set parameters
        """この辺self.optionで抱き合わせてinner_optionは最低限のstopping criterionだけにできるはず"""
        ...
        TRS_tolresid = inner_option["TRS_tolresid"]
        ...
        while True:
            ...
            if checkTRSoptimality:
                pred = - 0.5 * manifold.inner_product(xCur, HwCur(dxCur), dxCur) - manifold.inner_product(xCur, cxCur, dxCur)
            ...
            if second_order_stationarity:
                ...
                if TRS_solver == 'Exact_RepMat':
                    ...
                    print("mineigval_TRS_quadratic", mineigval_criterion, mineigvalHwNew, -stopping_criterion_second_order)
                elif TRS_solver == 'Exact_Operator':
                    # dim = manifold.dim
                ...
                mineigvalHwNew = None  # ignore as the stopping criterion
    ...
    def run(self, problem):
        ...
        print(problem.eqconstraints)
        if problem.eqconstraints != []:
        ...
        # if Delta0 is None:
        Delta0 = Delta_bar / 8
        initial_TR_radius = Delta0
        print("initTR", initial_TR_radius, Delta_bar)
        ...
        while True:
            ...
            # """ここを下限でclip initial_TR_radius = max(initial_TR_radius, Delta0)みたいにすれば局所的収束性は保てる"""
